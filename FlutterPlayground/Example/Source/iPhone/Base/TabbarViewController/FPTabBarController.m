...
- (NSArray *)viewControllersForTabBar {
    ...
    FPHomeViewController *homeViewController = [[FPHomeViewController alloc] init];
    UIViewController *homeNavigationController = [[FPNavigationViewController alloc]
    ...
    FPFlutterViewController *secondViewController = [[FPFlutterViewController alloc] init];
    UIViewController *secondNavigationController = [[FPNavigationViewController alloc]
                                                   initWithRootViewController:secondViewController];
    
    FPViewController *thirdViewController = [[FPViewController alloc] init];
    UIViewController *thirdNavigationController = [[FPNavigationViewController alloc]
                                                   initWithRootViewController:thirdViewController];
    
    FPViewController *fourthViewController = [[FPViewController alloc] init];
    UIViewController *fourthNavigationController = [[FPNavigationViewController alloc]
